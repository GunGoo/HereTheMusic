...
public class HereTheMusic extends Activity {
    private static final String LOG_TAG = HereTheMusic.class.getSimpleName();
    ...
    private void initialize() {
        setContentView(R.layout.activity_here_the_music);
